...
class _Vector:
    ...
    def __mod__(self, other: t.Self | float) -> t.Self: ...

    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...

    def __buffer__(self, flags: int) -> memoryview: ...
    def __release_buffer__(self, buf: memoryview) -> None: ...
...
class Quaternion:
    ...
    @classmethod
    def from_euler_deg(cls, rotatrion: Vector3) -> t.Self: ...

    @classmethod
    def from_euler_rad(cls, rotatrion: Vector3) -> t.Self: ...
...
class _Matrix[TVec]:
    ...
    @t.overload
    def __mod__(self, other: t.Self) -> t.Self: ...

    @t.overload
    def __mod__(self, other: int) -> t.Self: ...

    @t.overload
    def __mod__(self, other: float) -> t.Self: ...
