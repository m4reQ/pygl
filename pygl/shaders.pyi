...
class Shader:
    ...
    def set_uniform_mat2(self, name: str, value: TSupportsBuffer | _Matrix, type: UniformType = UniformType.FLOAT, transpose: bool = False) -> None: ...
    def set_uniform_mat3(self, name: str, value: TSupportsBuffer | _Matrix, type: UniformType = UniformType.FLOAT, transpose: bool = False) -> None: ...
    def set_uniform_mat4(self, name: str, value: TSupportsBuffer | _Matrix, type: UniformType = UniformType.FLOAT, transpose: bool = False) -> None: ...
